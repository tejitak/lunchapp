...
define('teji/lunch/view/ShopListView',["backbone", "underscore", "jquery.cookie", "teji/lunch/view/ShopView", "flipsnap", "moment"], function(Backbone, _, cookie, ShopView, flipsnap, moment){
        ...
        showTimer: function(lunchTime){
                ...
                if(lunchTime.diff(currentTime, 'minutes') < 10){
                    setInterval(function () {
                        ...
                        $(".fnResultViewTitle").html("Vote countdown: " + countDownMinutes + ":" + ((countDownSeconds%60 < 10) ? "0" : "") + countDownSeconds%60);
